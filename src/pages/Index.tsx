    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-black relative overflow-hidden bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50">
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        ...
        <div className="flex flex-col items-center space-y-6">
          {/* Character with enhanced styling - made smaller and positioned lower */}
          <div className="relative mt-8">
            ...
            <img 
              ...
              className="w-[280px] h-[280px] object-contain animate-[bounce_3s_ease-in-out_infinite] relative z-10 drop-shadow-2xl"
            />
          </div>
