...
const PouGame = () => {
  ...
  return (
    <div className={`min-h-screen ${phase.background} transition-colors duration-500`}>
      {/* Top Bar - Stats */}
      ...
      <div className="max-w-md mx-auto mt-4 px-4">
        <div className={`bg-${currentPhase}-light rounded-lg p-4 shadow-md animate-fade-in`}>
